...
const Toko = () => {
    ...
    const getProduct = async() =>{
        var dataProduct = [{'nama' : 'Sasa/Bahan Tambahan Pangan (Penguat Rasa) 1kg',
            ...
            <div class="row my-5">
                <div class="col">
                    ...
                    <div className='container-fluid bg-light'>
                        <h3 className=' mt-5 text-upporcase'>Toko Cempaka</h3>
                        <p>Jln. Kenangan , Cempaka Putih , Jakarta Pusat</p>
                        <p>081212121221</p>
                    </div>
                </Card>
                </div>
